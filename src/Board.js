...
(function () {
  ...
  window.Board = Backbone.Model.extend({
    ...
    hasRowConflictAt: function (rowIndex) {
      ...
      //iterate through the array at that index
      //for every truthy element, increment counter by 1
    ...
    hasAnyRowConflicts: function () {
      // debugger;
      for (var arrayIndex in this.attributes) {
        var count = 0;
        for (var i = 0; i < this.attributes[arrayIndex].length; i++) {
          // debugger;
          if (this.attributes[arrayIndex][i]) {
            count++;
          }
          if (count > 1) {
            return true;
    ...
    hasMajorDiagonalConflictAt: function (majorDiagonalColumnIndexAtFirstRow) {
      ...
      for (var i = 0; i < lengthRemaining; i++) {
        ...
        conflict += currentRow[colIndex] || 0;   //make sure it is defined
        colIndex++;
      }
    ...
    hasMinorDiagonalConflictAt: function (minorDiagonalColumnIndexAtFirstRow) {
      ...
      var lengthRemaining = this.get('n');
    ...
    hasAnyMinorDiagonalConflicts: function () {
      var array = [];
      var start = this.get('n') * 2 - 2; //6
      var end = -1;

      for (var i = start; i > end; i--) {
        var bool = this.hasMinorDiagonalConflictAt(i);
        array.push(bool);
      }
